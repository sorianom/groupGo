...
TWOGTP="./bin/gogui-twogtp -black \"$BLACK\" -white \"$WHITE\" -alice \"$ALICE\" -aliceWeight 1 -albert \"$ALBERT\" -albertWeight 1 -john \"$JOHN\" -johnWeight 1 -francesco \"$FRANCESCO\" -francescoWeight 1 -size 9 -iteration 0 -path /home/cs102/test_gogui/ -initial 0 -games 10 -groupColor white -sgffile /home/cs102/test_gogui/0/result"

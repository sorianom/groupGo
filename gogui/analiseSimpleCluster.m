function analiseSimpleCluster()
    ...
    % ex 31
    wonWhite = [0, 3, 5, 7, 9, 10, 11, 13, 14, 15, 17, 18, 19, 20, 21, 24, 26, 27, 28, 30, 32, 34, 36, 37, 38, 40, 42, 43, 44, 46, 48, 49];
    ...
    nExperts = 4;
     ...
     % Loading white files
    for n = 1 : nExperts
        for i = 1 : numGamesWhite
            disp(strcat(exPrefix,'/',names(n),'-w-',int2str(i-1),'.log'));
            fname = strcat(exPrefix,'/',names(n),'-w-',int2str(i-1),'.log');
    ...
    print('-dpng',strcat('cluster/graphs/acceptsAllGames.png'));
    ...
    print('-dpng',strcat('cluster/graphs/acceptsWonGames.png'));
    ...
    print('-dpng',strcat('cluster/graphs/acceptsLostGames.png'));

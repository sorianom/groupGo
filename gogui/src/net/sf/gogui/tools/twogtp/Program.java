...
public class Program
{
    ...
    */
    ...
    public void setFastMode() throws GtpError
    {
    	// *** Must find a better way of doing this...
    	
    	if (m_defaultName == "Black")
    		send("go_param timelimit 0.1"); // Fuego 1.1
    	else if (m_defaultName == "Yellow")
    		send("time_settings 10"); // Pachi
    }
